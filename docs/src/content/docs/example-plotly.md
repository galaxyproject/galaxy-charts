---
title: Plotly
description: Interactive, high-quality JavaScript visualizations.
---
...
<a class="mt-2 flex justify-center" href="https://usegalaxy.org/visualizations/create/plotly">
  <img class="rounded shadow-lg" src="/galaxy-charts/examples/plotly.gif" alt="Demo" style="max-width:100%; height:auto;" />
</a>
