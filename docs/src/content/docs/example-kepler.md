---
title: Kepler.gl
description: Browser-based platform for visualizing large-scale geospatial data.
---
...
<a class="mt-2 flex justify-center" href="https://usegalaxy.org/visualizations/create/kepler">
  <img class="rounded shadow-lg" src="/galaxy-charts/examples/kepler.gif" alt="Demo" style="max-width:100%; height:auto;" />
</a>
