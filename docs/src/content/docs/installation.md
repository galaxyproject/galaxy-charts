...
<div class="flex justify-around items-center p-1 not-prose">
  <img class="border-2 rounded border-gray-100" src="/galaxy-charts/galaxy-charts-starter.jpg" alt="starter" width="80%">
</div>
...
When you're ready to publish, refer to the [Deploy to Galaxy](/galaxy-charts/deploy-plugin) section to share your visualization with the Galaxy community.
