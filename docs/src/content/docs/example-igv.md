---
title: IGV — Integrative Genome Browser
description: Interactive web-based tool for exploring genomic data.
---
...
<a class="mt-2 flex justify-center" href="https://usegalaxy.org/visualizations/create/igv">
  <img class="rounded shadow-lg" src="/galaxy-charts/examples/igv.gif" alt="IGV Demo" style="max-width:100%; height:auto;" />
</a>
