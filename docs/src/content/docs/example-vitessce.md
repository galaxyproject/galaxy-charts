---
title: Vitessce
description: Interactive web-based platform for high-dimensional single-cell and spatial omics data.
---
...
<a class="mt-2 flex justify-center" href="https://usegalaxy.org/visualizations/create/vitessce">
  <img class="rounded shadow-lg" src="/galaxy-charts/examples/vitessce.gif" alt="Demo" style="max-width:100%; height:auto;" />
</a>
