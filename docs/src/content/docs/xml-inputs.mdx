...
<InputDemo client:only="vue" type="boolean" label="My Boolean Label" help="My Boolean Help" name="my_boolean_name" />
...
<InputDemo client:only="vue" type="color" label="My Color Label" help="My Color Help" name="my_color_name" />
...
<InputDemo client:only="vue" type="text" label="My Text Label" help="My Text Help" name="my_text_name" />
