---
title: Niivue
description: Interactive web-based viewer for 3D neuroimaging data.
---
...
<a class="mt-2 flex justify-center" href="https://usegalaxy.org/visualizations/create/niivue">
  <img class="rounded shadow-lg" src="/galaxy-charts/examples/niivue.gif" alt="Demo" style="max-width:100%; height:auto;" />
</a>
